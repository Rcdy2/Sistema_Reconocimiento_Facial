...
class EmployeesListPage(QWidget):
    def __init__(self):
        super().__init__()
        self.setup_ui()
    ...
    def setup_title(self):
        ...
        self.title_label = QLabel("LISTA DE EMPLEADOS")
    ...
    def setup_table(self):
        ...
        self.table.setHorizontalHeaderLabels(["ID", "NOMBRE", "APELLIDO", "DNI", "CARGO", "FECHA REGISTRO"])
    ...
    def search_employee(self):
        ...
        try:
            cursor = conn.cursor()
            query = """
                SELECT id, nombre, apellido, dni, cargo, fecha_registro 
                FROM personal 
                WHERE LOWER(nombre) LIKE ? OR LOWER(apellido) LIKE ? OR dni LIKE ? 
            """
